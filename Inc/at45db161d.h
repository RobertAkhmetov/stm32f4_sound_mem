...
//#define DF_CS_inactive HAL_GPIO_WritePin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, GPIO_PinState PinState)//_cs = 1
/** Assert CS **/
//#define DF_CS_active digitalWrite(SLAVESELECT,LOW)
//#define DF_CS_active HAL_GPIO_WritePin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, GPIO_PinState PinState)//_cs = 0
...
//    public:
 ...
 //       void Init();
         ...
         * **/
uint8_t AT45_ReadStatusRegister(void);
...
void AT45_DeepPowerDown(void);
         ...
         * @warning UNTESTED
         **/
void AT45_ResumeFromDeepPowerDown(void);
