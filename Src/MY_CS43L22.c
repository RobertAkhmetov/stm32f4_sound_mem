...
static void write_register(uint8_t reg, uint8_t *data)
{
	iData[0] = reg;
	iData[1] = data[0];
	//HAL_I2C_Master_Transmit(&i2cx, DAC_I2C_ADDR, iData, 2, 100);//gggg
...
{
	iData[0] = reg;
	//HAL_I2C_Master_Transmit(&i2cx, DAC_I2C_ADDR, iData, 1, 100);//ggg
	//HAL_I2C_Master_Receive(&i2cx, DAC_I2C_ADDR, data, 1, 100);//ggg
}
